...
10.08.20
1) сделал компонент для отрисовки айтемов. Пока все в 1 компоненте - надо будет разделить. Также надо переписать функцию для перебора мапы айтемов в массив, который будет отрисовываться. Не олучилось отрисовать примечание для таблицы айтема - нужно сделать условие наличия заметок, в условие цикл, отрисовывающий заметки. Все заметки передаются в цикл, но цикл не отрисовывает заметки. Пока отложил
